...
/** @type {string} */
const CACHE_VERSION = '1719922284|96499911863';
/** @type {string} */
const CACHE_PREFIX = 'flappy bird-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'flappy-bird.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["flappy-bird.html","flappy-bird.js","flappy-bird.offline.html","flappy-bird.worker.js","flappy-bird.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["flappy-bird.wasm","flappy-bird.pck"];
